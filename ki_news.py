...
<body>
    ...
    <div class="container">
        <div class="stats">
            <div class="stat">
                <div class="stat-zahl">{len(alle_news)}</div>
                <div class="stat-label">News gefunden</div>
            </div>
            <div class="stat">
                <div class="stat-zahl">{len(post_lines)}</div>
                <div class="stat-label">Post-Vorschläge</div>
            </div>
            <div class="stat">
                <div class="stat-zahl">{len(set(n['source'] for n in alle_news))}</div>
        ...
        <div class="section-title" style="margin-top:24px">✍️ Post-Vorschläge für @CScampy</div>
        {posts_html}
    </div>
</body>
</html>"""

    pfad = os.path.join(os.path.expanduser("~"), "Desktop", "ki_news.html")
...
print("Post-Vorschläge werden generiert...")
